import{$ as F,$a as Se,A as C,Aa as ae,B as N,Ba as re,C as Dt,Ca as oe,D as v,Da as se,E as Ht,Ea as le,F as Q,Fa as ce,G as gt,Ga as de,H as m,Ha as it,I as Mt,Ia as me,J as U,Ja as nt,K as g,Ka as ft,L as k,La as x,M as _,Ma as he,N as Gt,Na as pe,O as D,Oa as ue,P as M,Pa as ge,Q as z,Qa as _t,R as B,Ra as T,Sa as fe,Ta as _e,U as qt,Ua as be,V as Zt,Va as ve,W as O,Wa as we,X as s,Y as c,Ya as xe,Z as Y,Za as ye,_ as X,_a as ke,a as yt,aa as E,b as Vt,ba as w,c as b,ca as d,d as jt,da as P,e as ot,ea as J,f as ht,fa as h,g as j,ga as p,h as kt,ha as Rt,i as Wt,ia as lt,j as St,ja as f,k as Ct,ka as $t,l as Qt,la as u,m as pt,ma as It,n as S,na as Kt,o as Nt,oa as Yt,p as y,pa as L,q as A,qa as Xt,r,ra as ct,s as Z,sa as tt,t as $,ta as Jt,u as W,ua as te,v as K,va as ee,w as ut,wa as R,x as st,xa as ie,y as I,ya as et,z as Ut,za as ne}from"./chunk-S5N3PDNS.js";function Ce(i,l){let e=!l?.manualCleanup?l?.injector?.get(ut)??r(ut):null,n=$e(l?.equal),a;l?.requireSync?a=C({kind:0},{equal:n}):a=C({kind:1,value:l?.initialValue},{equal:n});let o,q=i.subscribe({next:V=>a.set({kind:1,value:V}),error:V=>{a.set({kind:2,error:V}),o?.()},complete:()=>{o?.()}});if(l?.requireSync&&a().kind===0)throw new Nt(601,!1);return o=e?.onDestroy(q.unsubscribe.bind(q)),ct(()=>{let V=a();switch(V.kind){case 1:return V.value;case 2:throw V.error;case 0:throw new Nt(601,!1)}},{equal:l?.equal})}function $e(i=Object.is){return(l,t)=>l.kind===1&&t.kind===1&&i(l.value,t.value)}var Ne=(()=>{class i{static \u0275fac=function(e){return new(e||i)};static \u0275mod=k({type:i});static \u0275inj=y({imports:[T]})}return i})();var De=(()=>{class i{static \u0275fac=function(e){return new(e||i)};static \u0275mod=k({type:i});static \u0275inj=y({imports:[T]})}return i})();var Xe=["*"],Je=`.mdc-list {
  margin: 0;
  padding: 8px 0;
